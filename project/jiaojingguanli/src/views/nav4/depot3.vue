	...
	<section>
		...
		<el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form  :inline="true" :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
               ...
               <el-form-item label="停车场等级" prop="parkLevelCode">
                  <el-select :size="'mini'" v-model="editForm.parkLevelCode" placeholder="请选择">
                   <el-option
                       v-for="item in parkLevelCode"
                      :key="item.dicCode"
                      :label="item.dicName"
                      :value="item.dicCode">
                   </el-option>
               ...
               <el-form-item label="审批类型" prop="parkApplyNum">
                  <el-select :size="'mini'" v-model="editForm.parkApplyNum" placeholder="请选择">
                   <el-option
                       v-for="item in options"
                       :key="item.parkApplyNum"
                       :label="item.label"
                       :value="item.value">
				...
				<el-form-item label="始收费时间" prop="chargeStartTime">
				   <el-input v-model="editForm.chargeStartTime" ></el-input>
				</el-form-item>
				<el-form-item label="终收费时间" prop="chargeEndTime">
				   <el-input v-model="editForm.chargeEndTime" ></el-input>
				</el-form-item>
				<el-form-item label="所属道路" prop="blockId">
               ...
               <el-form-item label="所在位置" prop="coordX">
				...
				<el-form-item label="道路宽度" prop="roadWidth">
				   <el-input v-model="editForm.roadWidth" ></el-input>
				</el-form-item>
              ...
              <el-form-item label="启用时间">
					<el-date-picker type="date" placeholder="选择日期" v-model="editForm.buildTime"></el-date-picker>
				</el-form-item>
				<el-form-item label="长度" prop="length">
					<el-input v-model="editForm.length" ></el-input>
				</el-form-item>
				<el-form-item label="面积" prop="parkSize">
				   <el-input v-model="editForm.parkSize" ></el-input>
				</el-form-item>
		...
		<el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
			<el-form  :inline="true" :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
               ...
               <el-form-item label="停车场等级" prop="parkLevelCode">
                  <el-select :size="'mini'" v-model="addForm.parkLevelCode" placeholder="请选择">
                   <el-option
                       v-for="item in parkLevelCode"
                      :key="item.dicCode"
                      :label="item.dicName"
               ...
               <el-form-item label="审批类型" prop="parkApplyNum">
                  <el-select :size="'mini'" v-model="addForm.parkApplyNum" placeholder="请选择">
                   <el-option
                       v-for="item in options"
                       :key="item.parkApplyNum"
                       :label="item.label"
				...
				<el-form-item label="始收费时间" prop="chargeStartTime">
				   <el-input v-model="addForm.chargeStartTime" ></el-input>
				</el-form-item>
				<el-form-item label="终收费时间" prop="chargeEndTime">
				   <el-input v-model="addForm.chargeEndTime" ></el-input>
				</el-form-item>
				<el-form-item label="所属道路" prop="blockId">
               ...
               <el-form-item label="所在位置" prop="coordX">
				...
				<el-form-item label="道路宽度" prop="roadWidth">
				   <el-input v-model="addForm.roadWidth" ></el-input>
				</el-form-item>
				<el-form-item label="停车场电话" prop="phone">
              ...
              <el-form-item label="启用时间">
					<el-date-picker type="date" placeholder="选择日期" v-model="addForm.buildTime"></el-date-picker>
				</el-form-item>
				<el-form-item label="长度" prop="length">
					<el-input v-model="addForm.length" ></el-input>
				</el-form-item>
				<el-form-item label="面积" prop="parkSize">
				   <el-input v-model="addForm.parkSize" ></el-input>
				</el-form-item>
				<el-form-item label="备注" prop="memo">
  ...
  data() {
    return {
      ...
      addFormRules: {
        ...
        parkApplyNum: [{ required: true, message: "请输入内容", trigger: "blur" }],
        jobRankName: [
          { required: true, message: "请输入内容", trigger: "blur" }
        ],
        chargeStartTime: [{ required: true, message: "请输入内容", trigger: "blur" }],
          chargeEndTime: [{ required: true, message: "请输入内容", trigger: "blur" }],
            blockId: [{ required: true, message: "请输入内容", trigger: "blur" }],
              coordX: [{ required: true, message: "请输入内容", trigger: "blur" }],
               roadWidth: [{ required: true, message: "请输入内容", trigger: "blur" }],
        mobile: [

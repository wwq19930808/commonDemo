	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				<el-form-item>
					<el-input v-model="filters.trfDevId" placeholder="设备编码"></el-input>
				</el-form-item>
        <el-form-item>
          <el-input v-model="filters.trfDevName" placeholder="设备名称"></el-input>
        </el-form-item>
        <el-form-item>
		...
		<el-table :data="newslist" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="trfDevId" label="设备编码" width="120" sortable>
			</el-table-column>
			<el-table-column prop="trfDevName" label="设备名称" width="140"  sortable>
			</el-table-column>
			<el-table-column prop="devTypeName" label="设备类型" width="120" sortable>
			</el-table-column>
			<el-table-column prop="manufact" label="设备厂家" width="140" sortable>
			</el-table-column>
			<el-table-column prop="modelName" label="设备型号" width="120" sortable>
			</el-table-column>
			<el-table-column prop="regionName" label="行政区域" width="120" sortable>
			</el-table-column>
			<el-table-column prop="positionDesc" label="位置描述" width="180" sortable>
			</el-table-column>
			<el-table-column prop="positionTypeName" label="安装位置" width="120"  sortable>
			</el-table-column>
			<el-table-column prop="commModeName" label="通讯方式" width="120" sortable>
			</el-table-column>
			<el-table-column prop="commParam" label="设备ip" width="120" sortable>
			</el-table-column>
			<el-table-column prop="commValue" label="设备端口" width="120" sortable>
			</el-table-column>
			<el-table-column prop="deviceStatusName" label="设备状态" min-width="120" sortable>
			</el-table-column>
		...
		<el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form  :inline="true" :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				<el-form-item label="设备编码" prop="trfDevId">
					<el-input v-model="editForm.trfDevId" auto-complete="off"></el-input>
				</el-form-item>
					<el-form-item label="设备名称" prop="trfDevName">
					<el-input v-model="editForm.trfDevName" auto-complete="off"></el-input>
				</el-form-item>
				...
				<el-form-item label="设备型号" prop="modelCode">
					<el-select :size="'mini'" v-model="editForm.modelCode" placeholder="请选择">
                   <el-option
                      v-for="item in modelCode"
                      :key="item.dicCode"
                      :label="item.dicName"
                      :value="item.dicCode">
                   </el-option>
			 ...
			 <el-form-item label="行政区域" prop="regionId">
                  <el-select :size="'mini'" v-model="editForm.regionId" placeholder="请选择">
                   <el-option
					...
					<el-input v-model="editForm.netMode" auto-complete="off"></el-input>
				</el-form-item>
				
				<el-form-item label="安装位置" prop="positionTypeCode">
					<el-select :size="'mini'" v-model="editForm.positionTypeCode" placeholder="请选择">
                   <el-option
                      v-for="item in positionTypeCode"
                      :key="item.dicCode"
                      :label="item.dicName"
                      :value="item.dicCode">
                   </el-option>
				...
				<el-form-item label="设备IP" prop="commParam">
					<el-input v-model="editForm.commParam"></el-input>
				</el-form-item>
				<el-form-item label="设备端口" prop="commValue">
				...
				<el-form-item label="设备期数" prop="project">
		...
		<el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
			<el-form :inline="true" :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
				<el-form-item label="设备编码" prop="trfDevId">
					<el-input v-model="addForm.trfDevId" auto-complete="off"></el-input>
				</el-form-item>
					<el-form-item label="设备名称" prop="trfDevName">
					<el-input v-model="addForm.trfDevName" auto-complete="off"></el-input>
				</el-form-item>
					<el-form-item label="设备状态" prop="deviceStatusCode">
				...
				<el-form-item label="设备型号" prop="modelCode">
					<el-select :size="'mini'" v-model="addForm.modelCode" placeholder="请选择">
                   <el-option
                      v-for="item in modelCode"
                      :key="item.dicCode"
                      :label="item.dicName"
				 ...
				 <el-form-item label="行政区域" prop="regionId">
                  <el-select :size="'mini'" v-model="addForm.regionId" placeholder="请选择">
                   <el-option
					...
					<el-form-item label="联网状态" prop="netMode">
					<el-input v-model="addForm.netMode" auto-complete="off"></el-input>
				</el-form-item>
				
				<el-form-item label="安装位置" prop="positionTypeCode">
					<el-select :size="'mini'" v-model="addForm.positionTypeCode" placeholder="请选择">
                   <el-option
                      v-for="item in positionTypeCode"
                      :key="item.dicCode"
                      :label="item.dicName"
...
export default {
  data() {
    return {
      ...
      addLoading: false,
      addFormRules: {
        trfDevId: [{ required: true, message: "请输入内容", trigger: "blur" }],
        trfDevName: [
  ...
  methods: {
    ...
    getUsers() {
      ...
      para.trfDevName = this.filters.trfDevName;
      para.trfDevId = this.filters.trfDevId;
      ...
      para.modelCode = this.filters.modelCode;
      this.listLoading = true;
      getPageTrFlowDevInfo({ data: JSON.stringify(para) }).then(res => {
        console.log(res);
    ...
    handleDel: function(index, row) {
      this.$confirm("确认删除该记录吗?", "提示", {
        ...
        .then(() => {
          this.listLoading = true;
          //NProgress.start();
          let para = { trfDevId: row.trfDevId };
          console.log(para);
          removeTrFlowDevInfo({ data: JSON.stringify(para) }).then(res => {
            console.log(res);
            this.listLoading = false;
            //NProgress.done();
            this.$message({
      ...
      this.$refs.editForm.validate(valid => {
        if (valid) {
          this.$confirm("确认提交吗？", "提示", {}).then(() => {
            ...
            editTrFlowDevInfo({ data: JSON.stringify(para) }).then(res => {
          ...
          this.$confirm("确认提交吗？", "提示", {}).then(() => {
            ...
            para.birthDay =
              !para.birthDay || para.birthDay == ""
                ? ""
                : util.formatDate.format(new Date(para.birthDay), "yyyy-MM-dd");
            addTrFlowDevInfo({ data: JSON.stringify(para) }).then(res => {
              console.log(res);
    ...
    getDeviceDic: function() {
    
      getDeviceDic().then(resp => {
        let modelCode=[];

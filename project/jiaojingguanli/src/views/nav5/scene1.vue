	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				<el-form-item>
					<el-input v-model="filters.osDevId" placeholder="设备编码"></el-input>
				</el-form-item>
          <el-form-item >
		...
		<el-table :data="newslist" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="osDevId" label="设备编码" width="130" sortable>
			</el-table-column>
			<el-table-column prop="devTypeName" label="设备类型" width="130"  sortable>
			</el-table-column>
			<el-table-column prop="devDesc" label="设备描述" width="120" sortable>
			</el-table-column>
			<el-table-column prop="manufact" label="生产厂商" width="130" sortable>
			</el-table-column>
			...
			<el-table-column prop="offsiteId" label="所在点位编码" width="150" sortable>
			</el-table-column>
		...
		<el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :inline="true" :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				<el-form-item label="设备编码" prop="osDevId">
					<el-input v-model="editForm.osDevId" auto-complete="off"></el-input>
				</el-form-item>
				...
				<el-form-item label="设备描述"  prop="devDesc">
					<el-input v-model="editForm.devDesc"></el-input>
				</el-form-item>
				...
				<el-form-item label="所在点位"  prop="offsiteId">
					<el-input v-model="editForm.offsiteId"></el-input>
				</el-form-item>
				...
				<el-form-item label="管理编码" prop="manageId">
					<el-input v-model="editForm.manageId" auto-complete="off"></el-input>
				</el-form-item>
		...
		<el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
			<el-form :inline="true" :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
				<el-form-item label="设备编码" prop="osDevId">
					<el-input v-model="addForm.osDevId" auto-complete="off"></el-input>
				</el-form-item>
				...
				<el-form-item label="设备描述"  prop="devDesc">
					<el-input v-model="addForm.devDesc"></el-input>
				</el-form-item>
					<el-form-item label="生产厂商"  prop="manufact">
				...
				<el-form-item label="所在点位"  prop="offsiteId">
					<el-input v-model="addForm.offsiteId"></el-input>
				</el-form-item>
				<el-form-item label="管理部门"  prop="manageDept">
					<el-input v-model="addForm.manageDept"></el-input>
				</el-form-item>
				<el-form-item label="管理编码" prop="manageId">
					<el-input v-model="addForm.manageId" auto-complete="off"></el-input>
				</el-form-item>
					<el-form-item label="建设项目" prop="project">
...
import {
 getPageOffsiteDevInfo,
  // batchRemoveUser,
 addOffsiteDevInfo,
  editOffsiteDevInfo,
  removeOffsiteDevInfo,
  getDicInfoDob,
...
export default {
  data() {
    return {
      ...
      addLoading: false,
      addFormRules: {
        osDevId: [{ required: true, message: "请输入内容", trigger: "blur" }],
        devTypeCode: [
  ...
  methods: {
    ...
    getUsers() {
      ...
      para.devTypeName = this.filters.devTypeName;
      para.osDevId = this.filters.osDevId;
      para.deviceStatusCode = this.filters.deviceStatusCode;
      this.listLoading = true;
      getPageOffsiteDevInfo({ data: JSON.stringify(para) }).then(res => {
        console.log(res);
    ...
    handleDel: function(index, row) {
      this.$confirm("确认删除该记录吗?", "提示", {
        ...
        .then(() => {
          this.listLoading = true;
          //NProgress.start();
          let para = { osDevId: row.osDevId };
          console.log(para);
          removeOffsiteDevInfo({ data: JSON.stringify(para) }).then(res => {
            console.log(res);
            this.listLoading = false;
            //NProgress.done();
            this.$message({
      ...
      this.$refs.editForm.validate(valid => {
        if (valid) {
          this.$confirm("确认提交吗？", "提示", {}).then(() => {
            ...
            editOffsiteDevInfo({ data: JSON.stringify(para) }).then(res => {
          ...
          this.$confirm("确认提交吗？", "提示", {}).then(() => {
            ...
            para.birthDay =
              !para.birthDay || para.birthDay == ""
                ? ""
                : util.formatDate.format(new Date(para.birthDay), "yyyy-MM-dd");
            addOffsiteDevInfo({ data: JSON.stringify(para) }).then(res => {
              console.log(res);

<template>
	<section>
		...
		<el-table :data="newslist" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="localDeptName" label="所在部门" width="160" sortable>
			</el-table-column>
			<el-table-column prop="operatorTypeCode" label="操作类型" width="130" sortable>
			</el-table-column>
			<el-table-column prop="recordPerson" label="登记人" width="130" sortable>
			</el-table-column>
			<el-table-column prop="responsiblePersonName" label="负责人" width="130" sortable>
			</el-table-column>
			<el-table-column prop="recordTime" label="登记时间" width="130" sortable>
			</el-table-column>			
			<el-table-column prop="memo" label="备注" min-width="150" sortable>
			</el-table-column>
		...
		<!-- <el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
			<el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="购入日期">
					<el-date-picker type="date" placeholder="选择日期" v-model="editForm.storageDate"></el-date-picker>
				</el-form-item>
...
export default {
  ...
  methods: {
    ...
    getUsers() {
      ...
      getDeviceOpratorPage({ data: JSON.stringify(para) }).then(res => {
        console.log(res);
